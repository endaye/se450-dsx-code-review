...
public class ProductService {
    ...
    public synchronized void setMarketState(MarketState ms) 
            throws InvalidMarketStateTransition, NotSubscribedException, DataValidationException, OrderNotFoundException, InvalidPriceOperation, InvalidMessageDataException {
    ...
    public synchronized void submitQuote(Quote q) 
            throws InvalidMarketStateException, DataValidationException, 
                    NoSuchProductException, NotSubscribedException, InvalidTradableValue, InvalidPriceOperation, InvalidMessageDataException {
        if (q == null) {
    ...
    public synchronized String submitOrder(Order o) 
            throws InvalidMarketStateException, DataValidationException, 
                    NoSuchProductException, NotSubscribedException, InvalidPriceOperation, InvalidMessageDataException {
        if (o == null) {
    ...
    public synchronized void submitOrderCancel(String product,
            BookSide side,String orderId) throws InvalidMarketStateException, 
                DataValidationException, NoSuchProductException, OrderNotFoundException, InvalidMessageDataException {
    ...
    public synchronized void submitQuoteCancel(String userName, String product) 
            throws InvalidMarketStateException, 
                DataValidationException, NoSuchProductException, InvalidMessageDataException {
